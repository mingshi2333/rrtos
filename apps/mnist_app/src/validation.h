...
typedef enum {
    ...
    MNIST_VALIDATION_BASELINE_MISSING = 1,
    MNIST_VALIDATION_HASH_MISMATCH = 2,
    MNIST_VALIDATION_PERF_STATS_MISSING = 3,
    MNIST_VALIDATION_INFERENCE_COUNT_MISMATCH = 4,
    MNIST_VALIDATION_LATENCY_MISSING = 5,
