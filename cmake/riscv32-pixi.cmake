...
# Target flags (RV32IMAFDC with hard-float ABI)
set(RISCV_FLAGS "--target=riscv32-unknown-elf -march=rv32imafdcv -mabi=ilp32d -mcmodel=medany")
...
execute_process(COMMAND /usr/bin/riscv64-linux-gnu-gcc -march=rv32imafdcv -mabi=ilp32d -print-libgcc-file-name OUTPUT_VARIABLE LIBGCC_PATH OUTPUT_STRIP_TRAILING_WHITESPACE ERROR_QUIET)
if(LIBGCC_PATH AND EXISTS "${LIBGCC_PATH}")
  ...
  set(CMAKE_EXE_LINKER_FLAGS_INIT "${RISCV_FLAGS} -nostdlib -nostartfiles -static -fuse-ld=lld -Wl,--gc-sections -L${LIBGCC_DIR} -lgcc")
else()
...
set(RISCV_ARCH "rv32imafdcv" CACHE STRING "RISC-V architecture")
